...
import { UPDATE_USER_PASSWORD, UPDATE_USER } from "../../store/api/constants";
...
export const Profile = (props) => {
  ...
  const handleOnPasswordChangeSubmit = (e) => {
    ...
    axios
      .put(UPDATE_USER_PASSWORD, payload)
      .then((res) => {
  ...
  return (
    <div className={styles.container}>
      <form className={styles.form} onSubmit={handleOnSubmit}>
        ...
        <button type="submit">
          {loading ? (
            <Loader color="white" size="small" position="small" />
          ) : (
            "Submit"
          )}
        </button>
      ...
      {modal ? (
        <div className={styles.passwordModal}>
          ...
          <form className={styles.form} onSubmit={handleOnPasswordChangeSubmit}>
            ...
            <label>
              {error.passwordCheck ? (
                <p className={styles.error}>{error.passwordCheck}</p>
              ) : undefined}
            ...
            <button type="submit">
              {passwordLoading ? (
                <Loader color="white" size="small" position="center" />
              ) : (
                "Submit"
              )}
            </button>
