...
const Header = ({ currentPage, isDefaultPassword }) => {
  const [notifications, setNotifications] = useState([{
    title: "Great news dear agents! You can now make electricity payments with CICO! From your home page click on BILL PAYMENT, next click PAY ELECTRICITY to use this exciting new feature."
  },{
