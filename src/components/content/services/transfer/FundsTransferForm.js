...
export const FundsTransferForm = (props) => {
  const { FundsTransferFormState: state, dispatch, setComponentToRender, transactionCost } = props;
    ...
    <form className={styles.form} autoComplete="off" onSubmit={handleOnContinue} >
      ...
      <label>
        ...
        <select 
          ...
          className={validationErrors.beneficiaryBankCode ? styles.outlineRed : styles.outlineGrey}>
        ...
        {validationErrors.beneficiaryBankCode ? <p className={styles.validationErrorText}>Please select bank</p> : undefined}
      </label>  
      <label>
        <span>Amount</span>
        <input 
        ...
        />    
        {validationErrors.amount ? <p className={styles.validationErrorText}>Please enter valid amount</p> : undefined}
      </label>
      <label>
        ...
        <input 
          ...
          type="text" 
          onChange={handleFormStateChange} 
          className={validationErrors.accountNumber ? styles.outlineRed : styles.outlineGrey}
        />     
        {validationErrors.accountNumber ? <p className={styles.validationErrorText}>Please enter account number</p> : undefined}
      </label>
      <label>
        ...
        <p className={styles.validationErrorText}>Account verification failed please check account number and try again</p> 
        : undefined}
      </label>  
      <label>
      ...
      <label>
        ...
        <input 
          ...
          onChange={handleFormStateChange} 
          className={validationErrors.narration? styles.outlineRed : styles.outlineGrey} 
        /> 
        {validationErrors.narration ? <p className={styles.validationErrorText}>Narration is required</p> : undefined}
      </label>          
      {state.beneficiaryBankCode && state.beneficiaryBankName && state.amount && state.accountNumber
      && state.accountName && state.phone && state.narration && state.total ? <button type="submit">Continue</button> : undefined }
    </form>
  )
};
