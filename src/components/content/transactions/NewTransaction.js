...
export const NewTransaction = ({ changeCurrentPage }) => {
  ...
  <div className={style.container}>
    <div className={style.cardContainer}>
      <Card link="transfer" text="Transfer Funds" size="large" image={transfer} />
      ...
      <Card link="recharge-cable" text="Recharge Cable TV" size="large" image={cabletv} />
      <Card link="buy-data" text="Buy Data" size="large" image={data} />
      <Card link="wallet-transfer" text="Betting" size="large" image={betting} />
      <Card link="wallet-transfer" text="Wallet Transfer" size="large" image={wallet} />
      <Card link="education" text="Education" size="large" image={education} />
