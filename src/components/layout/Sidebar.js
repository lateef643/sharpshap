    ...
    <nav className={styles.navigation}>
      ...
      <div className={styles.sidebar}>
        ...
        <div className={styles.links}>
          <NavLink to="/overview" className={styles.linkItem}>
            <img src={dashboard} className={styles.linkItemImage} alt="" />
            <p className={styles.linkItemText}>Overview</p>
          </NavLink>
          <NavLink to="/wallet" className={styles.linkItem}>
            <img src={wallet} className={styles.linkItemImage} alt="" />
            ...
            <div className={styles.linkSecondary}>
              ...
              <NavLink to="/wallet/fund" className={styles.linkSecondaryItem}>
                <p>Fund Wallet</p>
              </NavLink>
          ...
          <NavLink to="/transactions" className={styles.linkItem}>
            <img src={business} className={styles.linkItemImage} alt="" />
          ...
          <NavLink to="/profile" className={styles.linkItem}>
            <img src={user} className={styles.linkItemImage} alt="" />
