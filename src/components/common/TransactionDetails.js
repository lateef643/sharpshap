              ...
              {requeryLoading && <ThreeDots fill="#3E215B" />}
                    ...
                    <div className={styles.message}>
                        <a
                            ...
                            href={`mailto: hello@egolepay.com?subject=Transaction%20Details&body=ref:${transaction.reference}%20amount=${transaction.amount}%20date=${transaction.created_at}`}
                        >
                            <img
